KUNCI ACTIVE SIDEBAR ADA DI "FILL SLATE" PADA KOMPONEN PATH  
    ...
    <aside
        ...
        <div class="h-19.5">
            ...
            <a
                ...
                target="_blank">
                <span
                    class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">SPK</span>
            </a>
        </div>
        ...
        <div>
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a
                        class="shadow-soft-xl font-semibold text-slate-700 py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 transition-colors"
                ...
                <li class="mt-0.5 w-full">
                    <a
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Penilaian penyiar</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Virtual Reality</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">RTL</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Sign Up</span>
                    </a>
                </li>
            </ul>
        </div>
